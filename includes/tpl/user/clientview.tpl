...
<div class="row sub_menu">
	<div class="span14">
	<ul class="tabs">
		<li><a href="?page=users&amp;sub=search&amp;do={$ID}"><img src="{$url}themes/icons/user_go.png" /> Details</a></li>
		...
		<li><a href="?page=users&amp;sub=email&amp;do={$ID}&amp;"><img src="{$url}themes/icons/email.png" /> Email</a></li>
