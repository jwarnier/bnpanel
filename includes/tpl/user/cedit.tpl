	...
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
	  ...
	  <tr>
	    ...
	    <td>
	      ...
	      <a title="Your phone number." class="tooltip">
	      	<img src="{$icon_dir}information.png" />
	      </a>
	    </td>
	  </tr>
	  <tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="1">
			  	<tr>
			    	...
			    	<td><input type="password" name="currentpass" id="currentpass" />
			     		<a title="Type your current password here." class="tooltip"><img src="{$icon_dir}information.png" /></a>
			     	</td>
			  	</tr>
			  	<tr>
			    	<td>New Password:</td>
			    	<td><input type="password" name="newpass" id="newpass" />
			    		<a title="Type your new password here." class="tooltip"><img src="{$icon_dir}information.png" /></a>
			    	</td>
			  	</tr>
			  	<tr>
			    	<td>Confirm Password:</td>
			    	<td><input type="password" name="cpass" id="cpass" />
			     		<a title="Confirm your new password here." class="tooltip"><img src="{$icon_dir}information.png" /></a>
			     	</td>
			  	</tr>
				</table>
			</div>		
