	<div class="portlet" id="portlet-{$ID}">
		...
		<div class="portlet-content">
			<div class="portlet-icons">
				<a class="tooltip" title="Delete NavLink"><img src="{$icon_dir}delete.png" alt="Delete" class="deleteIcon" id="deleteIcon-{$ID}" /></a>
			</div>
			<table>
				<tr>
				...
				<tr>
					...
					<td><a class="tooltip" title="The icons that your users see next to the navigation link. Icons are located in the 'themes/icons' folder. Example: stop.png">
					<img src="{$icon_dir}picture.png" alt="Picture" /></a></td>
				</tr>
				<tr>
