...
(20, 'orders_active',  			'Order: Active',		 		 	'Order Activated', 			'<p><strong>Order #%ORDER_ID% is active.<br /></strong>', 	'This is the email a client receives when they''ve got an order cancelled. There are certain variables: %ORDER_ID%<br />'),
(21, 'orders_waiting_admin',	'Order: Waiting Admin Validation',  'Order Waiting Admin Validation','<p><span style="font-weight: bold;">Your Order #%ORDER_ID% is waiting for admin validation!<br /><span style="font-weight: normal;">Your account has been successfully created but you need to wait for an admin to approve your web hosting! You''re now able to log into your client control panel. Your details are as follows:</span></span></p><p><span style="font-weight: bold;">Username:&nbsp;</span>%USER%<br /><span style="font-weight: bold;">Password:&nbsp;</span>%PASS%<br /><span style="font-weight: bold;">Email:&nbsp;</span>%EMAIL%<br /><span style="font-weight: bold;">Domain/Subdomain:&nbsp;</span>%DOMAIN%<br /><span style="font-weight: bold;">Package:&nbsp;</span>%PACKAGE%<br /></p></div></span></p>', 'This is the email a client gets when they first go though the order form and complete it but are awaiting the admin. This email should contain all they''re details.<br /><br />Template Variables:<br />%USER% - Client Username<br />%PASS% - Client Password<br />%EMAIL% - Client Email<br />%DOMAIN% - The clients package url<br />%PACKAGE% - The package the client signed up for<br />%CONFIRM% - The confirmation link'),
(22, 'orders_cancelled',  		'Order: Cancelled', 				'Order Cancelled', 			'<p><strong>Order #%ORDER_ID% cancelled.<br /></strong>', 	'This is the email a client receives when they''ve got an invoice cancelled. There are certain variables: %ORDER_ID%<br />'),
(23, 'orders_needs_validation', 'Order: Admin: Needs Validation',  	'Order Waiting for Validation','<p><strong>Order #%ORDER_ID% waiting for validation.<br /></strong>', 	'This is the email a client receives when they''ve got an order cancelled. There are certain variables: %ORDER_ID%<br />'),

(24, 'invoices_new', 			'Invoice: Added', 					'New Invoice', 				'<p><strong>You have a new unpaid invoice on your account!<br /></strong>Make sure you log into your client area (%USER%) and pay the invoice.</p>\r\n<p><strong>Invoice Due date: </strong>%DUE%</p>', 'This is the email a client receives when they''ve got a new unpaid invoice. There are certain variables:<br />\r\n%USER% - Username<br />\r\n%DUE% - The Invoice Due Date\r\n'),
(25, 'invoices_paid', 			'Invoice: Paid', 					'Invoice Paid',				'<p><strong>Invoice #%INVOICE_ID% paid. <br /></strong>',		'This is the email a client receives when they''ve got an invoice paid. There are certain variables: %INVOICE_ID%<br />'),
(26, 'invoices_pending',  		'Invoice: Pending',					'Invoice Pending',			'<p><strong>Invoice #%INVOICE_ID% pending.<br /></strong>', 	'This is the email a client receives when they''ve got a pending invoice. There are certain variables: %INVOICE_ID%<br />'),
(27, 'invoices_cancelled',  	'Invoice: Cancelled', 				'Invoice Cancelled',		'<p><strong>Invoice #%INVOICE_ID% cancelled.<br /></strong>', 	'This is the email a client receives when they''ve got an invoice cancelled. There are certain variables: %INVOICE_ID%<br />');
