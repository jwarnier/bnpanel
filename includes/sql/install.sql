...
(20, 'cancel_order', 			'Web Package Cancelled', 		'Web Package Cancelled', '<p><span style="font-weight: bold;">Your web hosting package has been cancelled!<br /> <strong>Domain:</strong> %DOMAIN% <br /><br /><span style="font-weight: normal;"> <br /><br /><span style="font-weight: bold;">Reason for cancellation: </span>%REASON%</span></span></p>', 'This is the email the client recives when their order has been cancelled by admin or when they manually cancel it in the client control panel.<br /><br />\r\n\r\nEmail Variables:<br />\r\n%REASON% - The reason why their account has been cancelled'),
(21, 'admin_order_validation',  'Admin - Order Needs Validating', 'Order Awaiting Validation', '<p><span style="font-weight: bold;">A Client Is Awaiting Admin Validation for his order!<br /><span style="font-weight: normal;">Log into the system to approve or decline that order.</span></span></p>', 'This the email you recieve when a user has signed up to a package requiring admin validation and is awaiting it.'),
