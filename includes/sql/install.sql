...
(25, 'invoices_paid', 			'Invoice: Paid', 					'Invoice Paid',				'<p>Dear %USERNAME%,</p><p><strong>Your invoice #%INVOICE_ID% is paid. <br /></strong>',		'This is the email a client receives when they''ve got an invoice paid. There are certain variables: %INVOICE_ID%<br />'),
(26, 'invoices_pending',  		'Invoice: Pending',					'Invoice Pending',			'<p>Dear %USERNAME%,</p><p><strong>Your invoice #%INVOICE_ID% is pending.<br /></strong>', 	'This is the email a client receives when they''ve got a pending invoice. There are certain variables: %INVOICE_ID%<br />'),
