...
(20, 'cancel_order', 'Web Package Cancelled', 'Web Package Cancelled', '<p><span style="font-weight: bold;">Your web hosting package has been cancelled!<br /><span style="font-weight: normal;"> <br /><br /><span style="font-weight: bold;">Reason for cancellation: </span>%REASON%</span></span></p>', 'This is the email the client recives when their order has been cancelled by admin or when they manually cancel it in the client control panel.<br /><br />\r\n\r\nEmail Variables:<br />\r\n%REASON% - The reason why their account has been cancelled'),
