...
class page {
	...
	public function __construct() {
		$this->navtitle = "Payment Sub Menu";
		$this->navlist[] = array("View payment plugins", "magnifier.png", "view");
		$this->navlist[] = array("Add payment cycle Statistics", "book.png", "stats");
	...
	public function content() { # Displays the page 
		...
		switch($main->getvar['sub']) {
			...
			case "view":
				...
				$plugins_list = $new_list->availablePlugins();
				
				$array['PLUGINS'] = '<table width="100%" border="0" cellspacing="0" cellpadding="1">';
				foreach($plugins_list as $plugin) {
					$array['PLUGINS'] .= '<tr><td width="30%" align="left">'.$plugin['name'].':</td><td><input name="plugin_'.$plugin['name'].'" id="pages_'.$plugin['name'].'" type="checkbox" value="1" /></td></tr>';
				}
				$array['PLUGINS'] .='</table>';
